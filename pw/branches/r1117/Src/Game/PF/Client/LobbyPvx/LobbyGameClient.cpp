...
static float g_fHybridPingPeriod = 5.0; // �� ��������� - ����� ����������� ���� ��� � ������� ������
REGISTER_VAR( "hybrid_ping_period", g_fHybridPingPeriod, STORAGE_NONE);

static float g_fHybridPingThreshold = 0.4f; // ���� ���� (� ��������) ������ ����� ��������, ����� ������� (�.�. ������� ���� warning � DebugVar "hybrid_ping_value")
REGISTER_VAR( "hybrid_ping_threshold", g_fHybridPingThreshold, STORAGE_NONE);

static float g_fHybridPingRequestTimeout = 20.0; // !=0: ����������� ���� ������ ����� ���������� ����������� �������, ��� �� ��������� ����. �������� ����� ����. �������
...
static WorldStepIntDebugVar g_fHybridPingValue( "hybrid_ping_value" ); // ���� ���������� ��������� ���������� �������� ping
...
void GameClient::RequestHybridPing()
{
  ...
  {// ��� � ��������� ���-�� ������ ����������� ���� (transit_time rpc-������� �� ������-������� � �������)
    ...
    if ( ( tm - timeLastPingRequest > g_fHybridPingPeriod )
         && (timeLastUnansweredPing == 0 || tm - timeLastUnansweredPing > g_fHybridPingRequestTimeout) ) // UnansweredPing ������������ � 0, ����� �������� �����
    {

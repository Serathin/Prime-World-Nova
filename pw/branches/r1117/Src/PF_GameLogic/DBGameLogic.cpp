...
int AILogicParameters::operator&( IBinSaver &saver )
{
	...
	saver.Add( 48, &minigameAbility );
	saver.Add( 49, &talentsBuyRange );
	saver.Add( 50, &defaultTalentsSet );
	saver.Add( 51, &talentBaseStatBudget );
	saver.Add( 52, &talentNaftaCostByLevel );
	saver.Add( 53, &talentVendorCostByRarity );
	saver.Add( 54, &pauseSeconds );
	saver.Add( 55, &derivativeStats );
	saver.Add( 56, &statsBudget );
	saver.Add( 57, &forceParameters );
	saver.Add( 58, &talentGroups );
	saver.Add( 59, &consumableGroups );
	saver.Add( 60, &talentKits );
	saver.Add( 61, &talentPacks );
	saver.Add( 62, &energyDamageReduction );
	saver.Add( 63, &physicalDamageReduction );
	saver.Add( 64, &heroStatisticsParams );
	saver.Add( 65, &expoModeParams );
	saver.Add( 66, &abilityAndDamageScalingParams );
	saver.Add( 67, &levelToExperienceTable );
	saver.Add( 68, &botsSettings );
	saver.Add( 69, &warFogRemoveTime );
	saver.Add( 70, &warFogRemoveRadius );
	saver.Add( 71, &maxCreepsCount );
	saver.Add( 72, &portal );
	saver.Add( 73, &heroRanks );
	saver.Add( 74, &baseEmblemHeroNeeds );
	saver.Add( 75, &behaviourTrackerParams );
...
void AILogicParameters::SerializeSelf( IXmlSaver &saver )
{
	...
	saver.Add( "minigameAbility", &minigameAbility );
...
void AILogicParameters::Assign( const AILogicParameters& _aILogicParameters )
{
	...
	minigameAbility = _aILogicParameters.minigameAbility;
